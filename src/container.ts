...
export const KEYS = {
  ...
  CHAT_REPO: 'chatRepo',
  CHAT_REACTION_REPO: 'chatReactionRepo',
  DM_REPO: 'dmRepo',
  DM_REACTION_REPO: 'dmReactionRepo',
  ...
  PLAYER_PROJECTIONS_REPO: 'playerProjectionsRepo',
  ...
  CHESS_CLOCK_REPO: 'chessClockRepo',
  ...
  GAME_PROGRESS_SERVICE: 'gameProgressService',
