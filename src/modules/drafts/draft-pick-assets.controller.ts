...
export class DraftPickAssetsController {
   ...
   */
  getLeaguePickAssets = async (req: AuthRequest, res: Response) => {
   ...
   */
  getSeasonPickAssets = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const leagueId = requireLeagueId(req);
   ...
   */
  getRosterPickAssets = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
