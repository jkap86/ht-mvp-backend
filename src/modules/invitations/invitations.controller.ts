...
export class InvitationsController {
   ...
   */
  getMyInvitations = async (req: AuthRequest, res: Response) => {
   ...
   */
  declineInvitation = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const invitationId = parseInt(req.params.id as string, 10);
   ...
   */
  cancelInvitation = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const invitationId = parseInt(req.params.id as string, 10);
   ...
   */
  getLeagueInvitations = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const leagueId = requireLeagueId(req);
   ...
   */
  searchUsersForInvite = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const leagueId = requireLeagueId(req);
