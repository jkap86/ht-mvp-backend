...
router.get('/pending', invitationsController.getMyInvitations);
...
export function createLeagueInvitationRoutes(): Router {
  ...
  leagueRouter.post('/', invitationsController.sendInvitation);

  // GET /api/leagues/:leagueId/invitations - Get league invitations (commissioner only)
  leagueRouter.get('/', invitationsController.getLeagueInvitations);
...
export function createUserSearchRoutes(): Router {
  ...
  searchRouter.get('/search', invitationsController.searchUsersForInvite);
