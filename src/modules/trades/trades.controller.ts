...
export class TradesController {
   ...
   */
  getTrade = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const leagueId = requireLeagueId(req);
   ...
   * Accept a trade
   */
  acceptTrade = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const tradeId = parseInt(req.params.tradeId as string, 10);
   ...
   * Reject a trade
   */
  rejectTrade = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const tradeId = parseInt(req.params.tradeId as string, 10);
   ...
   */
  cancelTrade = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const tradeId = parseInt(req.params.tradeId as string, 10);
   ...
   * Vote on a trade
   */
  voteTrade = async (req: AuthRequest, res: Response) => {
    const userId = requireUserId(req);
    const tradeId = parseInt(req.params.tradeId as string, 10);
