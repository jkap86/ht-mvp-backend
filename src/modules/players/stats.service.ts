...
export class StatsService {
  ...
  async calculateSeasonTotals(
    ...
    return {
      ...
      passYd: parseFloat(row.pass_yd),
      passTd: parseInt(row.pass_td),
      passInt: parseInt(row.pass_int),
      passAtt: parseInt(row.pass_att),
      passCmp: parseInt(row.pass_cmp),
      rushYd: parseFloat(row.rush_yd),
      rushTd: parseInt(row.rush_td),
      rushAtt: parseInt(row.rush_att),
      rec: parseInt(row.rec),
      recYd: parseFloat(row.rec_yd),
      recTd: parseInt(row.rec_td),
      recTgt: parseInt(row.rec_tgt),
  ...
  async getGameLogs(
    ...
    return result.rows.map((row) => ({
      ...
      passTd: parseInt(row.pass_td) || 0,
      passInt: parseInt(row.pass_int) || 0,
      rushYd: parseFloat(row.rush_yd) || 0,
      rushTd: parseInt(row.rush_td) || 0,
      rec: parseInt(row.rec) || 0,
      recYd: parseFloat(row.rec_yd) || 0,
      recTd: parseInt(row.rec_td) || 0,
